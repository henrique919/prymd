...
- **Bottom tab bar** — Board · Search · Add · Activity · Menu, thumb-reachable.
- **Comments & activity feed** on every job, plus a global Activity view.
- **Labels** — colored bars on card fronts (Urgent, Domestic, Commercial, External, Warranty, Awaiting trade).
- **Richer card fronts** — labels, badges (comments/photos/variations/date) and an assignee avatar.
- **Search** across jobs, builders, addresses and workers.
- **Your name** (Menu) attributes comments and sign-offs.
