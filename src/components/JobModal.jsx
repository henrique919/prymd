        ...
        <div className="modal__body">
          {tab === 'job' && (
            <div className="jobfields">
              ...
              <label className="field__label">Inspection tag</label>
              <label className="switch-row">
                <input
                  type="checkbox"
                  checked={Boolean(card.awaitingInspection)}
                  onChange={(e) => field('awaitingInspection', e.target.checked)}
                />
                <span>Awaiting inspection by builder / project team</span>
              </label>
